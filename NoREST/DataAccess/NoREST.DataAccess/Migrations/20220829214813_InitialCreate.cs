    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRestaurantBans", x => new { x.RestaurantId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserRestaurantBans_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserRestaurantBans_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRestaurantBans_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRestaurantBans_CreatedById",
                table: "UserRestaurantBans",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserRestaurantBans_UserId",
                table: "UserRestaurantBans",
                column: "UserId");
        }
