...
GO
PRINT N'Creating [dbo].[FK_Cities_States]...';
...
GO
PRINT N'Creating [dbo].[FK_Restaurant_Cities]...';


GO
ALTER TABLE [dbo].[Restaurant]
    ADD CONSTRAINT [FK_Restaurant_Cities] FOREIGN KEY ([CityID]) REFERENCES [dbo].[Cities] ([CityID]);


GO
PRINT N'Creating [dbo].[FK_Reviews_Users]...';
...
GO
PRINT N'Creating [dbo].[FK_Reviews_Restaurant]...';


GO
ALTER TABLE [dbo].[Reviews]
    ADD CONSTRAINT [FK_Reviews_Restaurant] FOREIGN KEY ([RestaurantID]) REFERENCES [dbo].[Restaurant] ([RestaurantID]);


GO
PRINT N'Creating [dbo].[FK_Reviews_Rating]...';


GO
ALTER TABLE [dbo].[Reviews]
    ADD CONSTRAINT [FK_Reviews_Rating] FOREIGN KEY ([RatingID]) REFERENCES [dbo].[Rating] ([RatingID]);


GO
PRINT N'Creating [dbo].[GetCityIDByCityName]...';
...
GO
PRINT N'Creating [dbo].[GetRestaurantIDByRestaurantName]...';
...
GO
PRINT N'Creating [dbo].[GetUserIDByName]...';
...
GO
PRINT N'Creating [dbo].[InsertReview]...';
...
GO
PRINT N'Creating [dbo].[GetAllReviewsByCity]...';
...
GO
PRINT N'Creating [dbo].[GetAllReviewsByRestaurant]...';
...
GO
PRINT N'Creating [dbo].[GetAllReviewsByUser]...';
...
INNER JOIN Rating rt ON rt.RatingDescription = rv.RatingID
INNER JOIN Cities c ON c.CityID = r.CityID
